...
[
  # Ăn sáng — Xôi (tất cả kèm dưa góp và hành khô)
  ...
  %{"name" => "Xôi gấc", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Xôi gà", "price" => "50000", "category_id" => an_sang.id},
  %{"name" => "Xôi pate xá xíu", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi pate chả", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi trứng kho chả", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi chả thịt kho", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi thịt kho ruốc", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi trứng kho ruốc", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi chả ruốc", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Xôi trứng kho thịt chả", "price" => "40000", "category_id" => an_sang.id},
  %{"name" => "Xôi pate chả trứng thịt", "price" => "50000", "category_id" => an_sang.id},
  %{"name" => "Xôi pate chả trứng xá xíu", "price" => "50000", "category_id" => an_sang.id},
  %{
    "name" => "Xôi pate xá xíu chả trứng thịt",
    "price" => "60000",
    "category_id" => an_sang.id
  },
  # Ăn sáng — Bánh mì & món cuốn
  %{"name" => "Sandwich", "price" => "20000", "category_id" => an_sang.id},
  %{
    "name" => "Bánh mì Sài Gòn",
    "description" => "Các loại, 20–40k tuỳ loại",
    "price" => "30000",
    "category_id" => an_sang.id
  },
  %{
    "name" => "Bánh mì pate xá xíu chả ruốc",
    "description" => "Đầy đủ",
    "price" => "30000",
    "category_id" => an_sang.id
  },
  ...
  %{"name" => "Bánh cuốn chả mỡ", "price" => "35000", "category_id" => an_sang.id},
  %{"name" => "Bánh đúc", "price" => "20000", "category_id" => an_sang.id},
  %{"name" => "Phở cuốn", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Cơm cuộn", "price" => "15000", "category_id" => an_sang.id},
  %{
    "name" => "Trứng vịt lộn",
    "description" => "2 quả, kèm rau răm và gừng",
    "price" => "20000",
    "category_id" => an_sang.id
  },
  # Ăn sáng — Bánh & đồ luộc
  %{"name" => "Bánh giò", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Bánh chưng", "price" => "12000", "category_id" => an_sang.id},
  %{"name" => "Bánh tẻ", "price" => "10000", "category_id" => an_sang.id},
  %{"name" => "Bánh khoai", "price" => "12000", "category_id" => an_sang.id},
  %{"name" => "Bánh nếp", "price" => "10000", "category_id" => an_sang.id},
  %{"name" => "Bánh giầy", "price" => "25000", "category_id" => an_sang.id},
  %{"name" => "Bánh dày quán gánh", "price" => "30000", "category_id" => an_sang.id},
  %{"name" => "Bánh dày kẹp giò", "price" => "15000", "category_id" => an_sang.id},
  ...
  %{"name" => "Sữa chua nếp cẩm", "price" => "15000", "category_id" => an_sang.id},
  # Ăn sáng — Chè & đồ uống
  %{"name" => "Chè bưởi", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Chè sen", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Chè trôi tàu", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Chè đỗ đen", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Chè thập cẩm", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Chè dầm dừa", "price" => "20000", "category_id" => an_sang.id},
  %{"name" => "Bánh chay", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Tào phớ", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Xôi chè", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Cháo đỗ đen", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Cháo đỗ xanh", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Trà thái", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Trà sữa truyền thống", "price" => "15000", "category_id" => an_sang.id},
  %{"name" => "Sữa đậu nành", "price" => "12000", "category_id" => an_sang.id},
  %{"name" => "Nước đỗ đen", "price" => "12000", "category_id" => an_sang.id},
  %{"name" => "Sữa ngô", "price" => "15000", "category_id" => an_sang.id},
  # Mixue — Dòng kem
  ...
  # Mixue — Trà hoa quả
  %{"name" => "Liên minh cam xoài", "price" => "25000", "category_id" => mixue.id},
  %{"name" => "Nước chanh tươi lạnh", "price" => "15000", "category_id" => mixue.id},
  %{"name" => "Trà xanh chanh", "price" => "17000", "category_id" => mixue.id},
  %{"name" => "Trà chanh lô hội", "price" => "20000", "category_id" => mixue.id},
  %{"name" => "Chanh leo bách hương", "price" => "25000", "category_id" => mixue.id},
  %{"name" => "Trà xanh hoa đào", "price" => "22000", "category_id" => mixue.id},
  %{"name" => "Trà cam dâu tây", "price" => "25000", "category_id" => mixue.id},
  %{"name" => "Trà đào bigsize", "price" => "22000", "category_id" => mixue.id},
  %{"name" => "Trà xoài chanh leo", "price" => "25000", "category_id" => mixue.id},
  %{"name" => "Trà đào dâu tây", "price" => "22000", "category_id" => mixue.id},
  %{"name" => "Trà cam vàng 9999", "price" => "25000", "category_id" => mixue.id},
  # Mixue — Trà sữa
  ...
  %{"name" => "Trà sữa hoa nhài", "price" => "20000", "category_id" => mixue.id},
  ...
  %{"name" => "Trà sữa thạch đường đen M", "price" => "25000", "category_id" => mixue.id},
  %{"name" => "Trà sữa thạch đường đen L", "price" => "30000", "category_id" => mixue.id},
  %{"name" => "Dương chi cam lộ", "price" => "25000", "category_id" => mixue.id},
  %{"name" => "Sữa thạch Dâu tây", "price" => "22000", "category_id" => mixue.id},
  # Mixue — Cà phê
  %{"name" => "Americano kem", "price" => "28000", "category_id" => mixue.id},
  %{"name" => "Cafe Latte Kem tươi", "price" => "30000", "category_id" => mixue.id},
  %{"name" => "Americano", "price" => "22000", "category_id" => mixue.id},
  %{"name" => "Cafe Latte", "price" => "28000", "category_id" => mixue.id},
  %{"name" => "Cafe latte caramel hạt dẻ", "price" => "28000", "category_id" => mixue.id},
  %{"name" => "Americano chanh", "price" => "28000", "category_id" => mixue.id},
  %{"name" => "Americano cam", "price" => "28000", "category_id" => mixue.id},
